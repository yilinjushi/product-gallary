    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
            ...
            >
                ...
                <div className="mb-6">
                    <span className="text-sm font-bold tracking-widest uppercase border-b border-white/20 pb-1 text-white">联系我们</span>
                </div>

                <p className="text-gray-400 leading-relaxed text-[15px] mb-2 whitespace-pre-wrap">
                    {text || '暂无联系信息。'}
                </p>
            </motion.div>
        </div>
